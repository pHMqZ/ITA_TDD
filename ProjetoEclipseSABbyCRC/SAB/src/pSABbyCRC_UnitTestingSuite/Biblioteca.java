...
public class Biblioteca {
	...
	public void registraUsuario(String nome)
		...
		if (nome == null)
			throw new UsuarioInexistenteException("--->N„o pode registrar usu·rio inexistente!");

		if (nome.isEmpty())
			throw new UsuarioComNomeVazioException("--->N„o pode registrar usu·rio com nome vazio!");
		Usuario usuario = new Usuario(nome);
		
		if (_usuarios.contains(usuario))
			throw new UsuarioJaRegistradoException(
					"--->J· existe usu·rio com o nome \"" + nome + "\"! Use outro nome!");
